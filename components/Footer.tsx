...
const Footer = () => {
  return (
    <footer className="bg-black-soft">
      <section className="css-footer-section relative px-6 pt-[52px] pb-[38px] text-white md:px-10 md:pt-[60px] md:pb-[46px] lg:mx-auto lg:max-w-[1190px] lg:pt-[75px] lg:pb-[48px]">
        <div className="flex flex-col items-center gap-12 md:items-start md:gap-0">
          <div className="flex flex-col items-center gap-12 md:mb-8 md:items-start md:gap-8 lg:w-full lg:flex-row lg:justify-between lg:gap-0">
            <Link href="/">
            ...
            <nav>
              <ul className="tracking-2 flex flex-col gap-4 text-center text-xs leading-25 font-bold uppercase md:flex-row md:gap-[34px]">
                <li>
                  <Link href="/">Home</Link>
                </li>
                <li>
          ...
          <p className="text-white-50 text-center md:mb-20 md:text-start lg:mb-14 lg:max-w-[540px]">
            {" "}
